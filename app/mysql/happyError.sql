...
CREATE TABLE `page_info` (
  ...
  CONSTRAINT `page_info_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`id`)
...
CREATE TABLE `js_error` (
  ...
  CONSTRAINT `js_error_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`id`)
...
CREATE TABLE `api_error` (
  ...
  CONSTRAINT `api_error_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `USERS` (`id`)
